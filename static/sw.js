...
const SHELL_CACHE = 'nlf-pos-shell-v4';
const API_CACHE   = 'nlf-pos-api-v4';
const ALL_CACHES  = [SHELL_CACHE, API_CACHE];

// --- App shell files to pre-cache on install ---
const SHELL_FILES = [
  '/',
  '/static/css/main.css?v=10',
  '/static/css/pos.css?v=10',
  '/static/css/labels.css?v=10',
  '/static/css/receipt.css?v=10',
  '/static/js/app.js?v=10',
  '/static/js/pos.js?v=10',
  '/static/js/inventory.js?v=10',
  '/static/js/labels.js?v=10',
  '/static/js/sales.js?v=10',
  '/static/js/reports.js?v=10',
  '/static/js/transactions.js?v=10',
  '/static/js/settings.js?v=10',
  '/static/js/suppliers.js?v=10',
  '/static/js/customers.js?v=10',
  '/static/js/orders.js?v=10',
  '/static/js/scanner.js?v=10',
  '/static/js/offline-store.js?v=10',
  '/static/img/logo.svg',
